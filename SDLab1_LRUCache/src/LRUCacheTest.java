...
public class LRUCacheTest {
    ...
    @Test
    public void mapTest() {
        LRUCache<String, Integer> cache = new LRUCacheImpl<>(1000);
        for (int i = 1; i <= 10; i++)
    ...
    public void cacheOverflowTest1() {
        LRUCache<Integer, String> cache = new LRUCacheImpl<>(100);
        for (int i = 1; i <= 200; i++)
    ...
    public void cacheOverflowTest2() {
        LRUCache<String, Integer> cache = new LRUCacheImpl<>(500);
    ...
    public void stressTest() {
        LRUCache<Integer, Integer> cache = new LRUCacheImpl<>(1_000_000);
